...
class MLModel:
    ...
    Attributes:
        ml_model_id (int): Уникальный идентификатор модели
        ml_model_name (str): Название модели
        description (str): Текстовое описание возможностей модели.
        cost_per_prediction (float): Стоимость одной генерации описания
    """
    def __init__(self, ml_model_id: int, ml_model_name: str, description: str, cost_per_prediction: float):
...
class MLTask:
    ...
    Attributes:
        ...
        ml_model (MLmodel): Объект ML-модели, которая будет выполнять задачу
    ...
    """
    def __init__(self, task_id: int, user: User, ml_model: MLModel, image_url: str, manual_text: str | None = None):
